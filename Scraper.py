...
def banner():
	print("""
\033[0;96m  FACEBOOK ACOUNTS SCRAPER  _________ __     
\033[0;96m    \033[0;96m║ \033[0;97mCoded By \033[0;96mHUNTER \033[0;97m& \033[0;96m4X4
\033[0;96m   \033[0;96m║ \033[0;97mFB \033[0;96m: \033[0;97mFacebook.com/
\033[0;96m  \033[0;96m║ \033[0;97mFB \033[0;96m: \033[0;97mFacebook.com/
\033[0;96m  \033[0;96m║ \033[0;97mGithub \033[0;96m: \033[0;97mGithub.com/
\033[0;96m─────────────────────────────────────────────────────────────""")
...
def menu():
  ...
  print("\033[0;96m║")
  print("\033[0;96m╠══\033[0;97m[1] Dump ID Public/Friend for Scraping")
  print("\033[0;96m╠══\033[0;97m[2] scrap ID's")
  print("\033[0;96m╚══\033[0;97m[0] Logout")
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  r=raw_input("\033[0;97m   [•] Input : ")
  if r=="":print("\033[0;97m   [!] Enter 15 Digit u-id").format(R,N);menu()
  elif r=="1":
    publik()
  elif r=="2":
    methode()
...
def publik():
	...
	try:
                ...
                banner()
                print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print("\033[0;96m╔══\033[0;97m[•] Enter User ID that's friends List is on Public")
		...
		ys.close()
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print ('\033[0;96m╔══\033[0;97m[•] Fetching Success %s'%op['name'])
...
def methode():
  ...
  banner()
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ Scraping Methods ]")
  print("\033[0;96m║")
  print("\033[0;96m╠══\033[0;97m[1] Scraping With mbasic")
  print("\033[0;96m╠══\033[0;97m[2] Scraping With m.facebook.com")
  print("\033[0;96m╠══\033[0;97m[3] Scraping With touch.facebook.com")
  print("\033[0;96m╚══\033[0;97m[4] Scraping With api")
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
...
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ Login Methods ]")
  print("\033[0;96m║")
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					continue
                                print ("\033[0;96m─────────────────────────────────────────────────────────────")
				print ("\033[0;96m╔══\033[0;97m[•] Scraping Started...")
...
class crack2:
	...
	def __init__(self):
		...
		self.cp=[]
		self.ko=0
		print("\033[0;96m╠══\033[0;97m[•] Scraping With Pass Default Or Manual [d/m]")
		while True:
			f=raw_input("\033[0;96m╠══\033[0;97m[•] Pilih : ")
			if f=="":continue
			elif f=="m":
